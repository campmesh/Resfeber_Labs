...
if (isset($_GET['code'])) 
{
	...
	if($website->Check_InDB_Google_FB($info['email'],'Google'))
	{
	...
	else
	{
		...
		$user_array=$website->InsrtInDB_Google($info);
...
<div class="wrapper row3">
  <main id="container" class="clear"> 
	...
	<form id="entermobile" action='confirmreg_mobile_Google_FB.php' method="get" accept-charset='UTF-8'>
		<fieldset>
